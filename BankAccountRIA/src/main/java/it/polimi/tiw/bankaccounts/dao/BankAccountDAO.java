...
public class BankAccountDAO {
	...
	public void createVoidAccount(User user) throws SQLException {
		String query = "INSERT INTO bankaccountsria.bankaccount (balance, owner) VALUES (0, ?);";
	...
	public List<BankAccount> getAccountsByUser(User user) throws SQLException {
		...
		String query = "SELECT A.* FROM bankaccountsria.bankaccount A WHERE owner = ?;";
	...
	public BankAccount getAccountDetails(int accountId, User user) throws SQLException {
		...
		String query = "SELECT A.* FROM bankaccountsria.bankaccount A WHERE id = ? AND owner = ?;";
		ResultSet result = null;
		PreparedStatement pstatement = null;
	...
	public Integer transferMoney(int senderAccountId, int receiverAccountId, double amount, String reason, User user)
		...
		String query1 = "UPDATE bankaccountsria.bankaccount SET balance = balance-? WHERE id = ?;";
		String query2 = "UPDATE bankaccountsria.bankaccount SET balance = balance+? WHERE id = ?;";
