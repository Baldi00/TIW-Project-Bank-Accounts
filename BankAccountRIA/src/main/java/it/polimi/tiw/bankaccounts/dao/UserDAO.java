...
public class UserDAO {
	...
	public User checkUserCredentials(String email, String password) throws SQLException {
		User user = null;
		String query = "SELECT * FROM bankaccountsria.user WHERE email = ? and password = ?";
	...
	public boolean checkIfUserPresent(String email) throws SQLException {
		String query = "SELECT * FROM bankaccountsria.user WHERE email = ?";
		ResultSet result = null;
		PreparedStatement pstatement = null;
	...
	public User registerUser(String name, String surname, String email, String password) throws SQLException {
		String query = "INSERT INTO bankaccountsria.user (name, surname, email, password) VALUES (?, ?, ?, ?);";
		PreparedStatement pstatement = null;
	...
	public User getUserByAccount(int accountId) throws SQLException {
		User user = null;
		String query = "SELECT U.* FROM bankaccountsria.user U JOIN bankaccountsria.bankaccount A ON U.id = A.owner WHERE A.id = ?";
		ResultSet result = null;
		PreparedStatement pstatement = null;
